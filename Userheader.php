...
<link rel="icon" href="assets/images/favicon.ico">
 <title>ONLINE HOME APPLIANCES SERVICE SYSTEM</title>
...
<div class="container">
	...
	ONLINE HOME APPLIANCES SERVICE SYSTEM
	</a>
	<!-- End Logo -->
	<!-- Begin Menu -->
	<div class="collapse navbar-collapse" id="navbarsWow">
		...
		<ul class="navbar-nav ml-auto">
			...
			<li class="nav-item">
			<a class="nav-link" href="Viewstatus1.php">Status</a>
			</li>
			<!-- <li class="nav-item">
			<a class="nav-link" href="Viewpayment.php">Payment</a>
			</li> -->
			<li class="nav-item">
